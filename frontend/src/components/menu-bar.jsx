...
function MenuBar() {
   ...
   * 
   * @param {string} v - The view name (e.g., 'home', 'orders', 'history', 'account')
   */
  const handleClick = (v) => {
  ...
  return (
    <StyledMenuBarWrapper className={'menu-bar'}>
      ...
      <MenuBarOption className={`menu-option-orders ${view == 'orders' ? 'selected' : ''}`} onClick={() => handleClick('orders')}>
        {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M212.31-140Q182-140 161-161q-21-21-21-51.31v-535.38Q140-778 161-799q21-21 51.31-21h55.38v-84.61h61.54V-820h303.08v-84.61h60V-820h55.38Q778-820 799-799q21 21 21 51.31v535.38Q820-182 799-161q-21 21-51.31 21H212.31ZM760-212.31v-535.38q0-4.62-3.85-8.46-3.84-3.85-8.46-3.85H212.31q-4.62 0-8.46 3.85-3.85 3.84-3.85 8.46v535.38q0 4.62 3.85 8.46 3.84 3.85 8.46 3.85h535.38q4.62 0 8.46-3.85 3.85-3.84 3.85-8.46Zm-386.15-73.84h47.69v-159.62q24.84-6.23 41.65-26T480-517v-156.85h-35.38v149.47h-29.23v-149.47H380v149.47h-29.23v-149.47h-35.38V-517q0 25.46 16.8 45.23 16.81 19.77 41.66 26v159.62Zm223.07 0h47.69v-387.31q-45.38 1.92-76.53 35-31.16 33.08-31.16 78.46v113.85h60v160ZM200-212.31V-200v-560V-212.31Z"/></svg> */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" ><path d="M180-180v-476l-74.15-162.31 54.3-25.53L245.69-658h468.62l85.54-185.84 54.3 25.53L780-656v476H180Zm220-270h160q12.75 0 21.37-8.63 8.63-8.63 8.63-21.38 0-12.76-8.63-21.37Q572.75-510 560-510H400q-12.75 0-21.37 8.63-8.63 8.63-8.63 21.38 0 12.76 8.63 21.37Q387.25-450 400-450Z"/></svg>            <h3>Orders</h3>
      </MenuBarOption>
      
      {/* History Navigation Button */}
      <MenuBarOption className={`menu-option-history' ${view == 'history' ? 'selected' : ''}`} onClick={() => handleClick('history')}>
        {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M479.23-140q-129.92 0-226.46-85.54Q156.23-311.08 141.62-440h61.23Q218-336.38 296.12-268.19 374.23-200 479.23-200q117 0 198.5-81.5t81.5-198.5q0-117-81.5-198.5T479.23-760q-65.54 0-122.84 29.12-57.31 29.11-98.7 80.11h104.62v60H159.23v-203.08h60v94.77q48.69-57.46 116.62-89.19Q403.77-820 479.23-820q70.77 0 132.62 26.77 61.84 26.77 107.84 72.77t72.77 107.85q26.77 61.84 26.77 132.61 0 70.77-26.77 132.61-26.77 61.85-72.77 107.85-46 46-107.84 72.77Q550-140 479.23-140Zm120.08-178.92L450.39-467.85V-680h59.99v187.85l131.08 131.07-42.15 42.16Z"/></svg>             */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m480-256.16 146.15-146.15L584-444.46l-74 74v-178h-60v178l-74-74-42.15 42.15L480-256.16ZM215.39-140q-29.93 0-52.66-22.73Q140-185.46 140-215.39v-464.38q0-12.84 4.12-24.5 4.11-11.65 12.34-21.5l56.16-67.92q9.84-12.85 24.61-19.58Q252-820 268.46-820h422.31q16.46 0 31.42 6.73T747-793.69L803.54-725q8.23 9.85 12.34 21.69 4.12 11.85 4.12 24.7v463.22q0 29.93-22.73 52.66Q774.54-140 744.61-140H215.39Zm.23-563.84H744l-43.62-51.93q-1.92-1.92-4.42-3.08-2.5-1.15-5.19-1.15H268.85q-2.69 0-5.2 1.15-2.5 1.16-4.42 3.08l-43.61 51.93Z"/></svg>        <h3>History</h3>
      </MenuBarOption>
